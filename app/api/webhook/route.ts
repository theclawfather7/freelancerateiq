...
function buildEmail(downloadLink: string): string {
  return [
    ...
    '<p style="color: #cbd5e1; line-height: 1.6;">Your purchase is confirmed. Here\'s your instant access link:</p>',
    '<div style="text-align: center; margin: 32px 0;">',
    '<a href="' + downloadLink + '" style="background: #10b981; color: white; text-decoration: none; font-weight: 700; padding: 16px 32px; border-radius: 8px; display: inline-block; font-size: 16px;">📄 Open Your Guide →</a>',
    '</div>',
    ...
    '</ul></div>',
    '<p style="color: #64748b; font-size: 13px;">Tip: Use browser Print → Save as PDF to save permanently.</p>',
    '<hr style="border: none; border-top: 1px solid #1e293b; margin: 32px 0;" />',
    '<p style="color: #475569; font-size: 12px; text-align: center;">FreelanceRateIQ · Questions? Reply to this email.<br />',
    '<a href="https://freelancerateiq.com" style="color: #10b981;">freelancerateiq.com</a></p>',
    '</div></body></html>',
  ].join('\n');
}
